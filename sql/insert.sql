...
insert into staff values (default, 'Sydney', 'Sydney', 'manager');
insert into staff values (default, 'Melbourne', 'Melbourne', 'manager');
insert into staff values (default, 'Brisbane', 'Brisbane', 'manager');
insert into staff values (default, 'Adelaide', 'Adelaide', 'manager');
insert into staff values (default, 'Hobart', 'Hobart', 'manager');
insert into staff values (default, 'Perth', 'Perth', 'manager');
